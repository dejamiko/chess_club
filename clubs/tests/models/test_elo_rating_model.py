...
class EloRatingModelTestCase(TestCase):
    ...
    def test_user_has_elo(self):
        elo_test_value = _elo_finder(self.user, self.club)
    ...
    def test_user_has_elo_after_joining_club(self):
        ...
        elo_test_value = _elo_finder(self.second_user, self.second_club)
    ...
    def test_user_elo_after_win(self):
        ...
        michael_rating = _elo_finder(self.michael, self.club)
        alice_rating = _elo_finder(self.alice, self.club)
    ...
    def test_separate_elo_for_different_club(self):
        self.second_club.make_member(self.second_user)
        jane_elo_club_1 = _elo_finder(self.second_user, self.club)
        jane_elo_club_2 = _elo_finder(self.second_user, self.second_club)
    ...
    def test_elo_exists_after_new_club_made(self):
        ...
        michael_third_club_elo = _elo_finder(self.michael, third_club)
